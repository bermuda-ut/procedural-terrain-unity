...
Implementation Steps:
	...
	6. Pass on array to mesh generator. It will divide up the array into appropriate number of meshes,
	   then generates the verticies and triangles, then calculates surface normal using Unity's
	   built-in method for meshes. Completed array of meshes are returned
