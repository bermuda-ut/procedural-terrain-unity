...
Implementation Steps:
	...
	3. Fill the squares in diamond-square steps. 2 noise values are added.
	   ...
	   By setting correct combination of slopeness and roughness, natural-looking terrain can be achieved
	...
	6. Pass on array to mesh generator. It will divide up the array into appropriate number of meshes,
	   then generates the verticies and triangles, then calculates surface normal using Unity's built-in
	   method for meshes. Completed array of meshes are returned
